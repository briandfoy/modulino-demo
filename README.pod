...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Modulino-Demo> or 
L<MetaCPAN|http://www.metacpan.org/module/Modulino::Demo>:

=over 4

=item *	L<http://search.cpan.org/dist/Modulino-Demo>

=item *	L<http://www.metacpan.org/module/Modulino::Demo>
